...
if(isset($_POST['acao']) && $_POST['acao'] =='update' ):
              ...
              $codigo_endereco = int_val(mysql_real_escape_string($_GET['codigo'])); 
...
<div id="carrinho"><a href="meuCarrinho.php">Meu Carrinho</a> <img src="images/carrinho2.png" height="20px">
           &nbsp;&nbsp;&nbsp;<a href="minhaConta.php"><img src="images/adm.png" height="20px"></a>&nbsp;&nbsp;&nbsp;<a href="logout.php">Logout</a>
</div>
...
exit();
    ...
    <div class="conteudo_informacoes">
     <form name="atualizar" action="" method="post">
            <caption><b>Editar Endereco</b></caption><br>
          Endereço Completo: <input type="text" name="endereco" required  value="<?php echo $endereco;  ?>" > <br>
          Cidade:            <input type="text" name="cidade" required value="<?php echo $cidade; ?>"> <br>
          Bairro:            <input type="text" name="bairro" value="<?php echo $bairro; ?>" required><br>
          CEP:               <input type="text" name="cep"  value="<?php echo $cep; ?>" required > <br>
          Numero:            <input type="text" name="numero" value="<?php echo $numero; ?>" required > <br>
          Cpf:               <input type="text" name="cep"  value="<?php echo $cep; ?>" required > <br>  
             ...
             <input  type="submit"  value="Atualizar Endereço" id="botoes" >&nbsp;&nbsp;&nbsp;&nbsp; <a href="minhaConta.php"><input type="button" value="voltar" class="botao" /></a>
           </form>
     </div>
              </div>
