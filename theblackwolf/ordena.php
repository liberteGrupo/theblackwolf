...
if($_POST['ordenar']){
if($_POST['ordena'] && $_POST['ordena'] === 'menor'){
   $produtos = ("SELECT * FROM produto ORDER BY PRECO_PRODUTO ASC ");
...
}elseif($_POST['ordena'] === 'maior'){

  $produtos = ("SELECT * FROM produto ORDER BY PRECO_PRODUTO DESC ");
   $listar_produtos = mysql_query($produtos);
   $i = 2;
   $loop = 5;
   while($produto = mysql_fetch_array($listar_produtos)){
