...
<input type="image" src="user/images/busca.png" value="enviar" alt="buscar!">
<a id="show-panel" href="#">Login</a>
<div id="carrinho"><a href="user/login.php">Meu Carrinho</a> <img src="user/images/carrinho2.png" height="20px"></div>
<!-- lightbox-panel -->
...
<div id="mapa1">/
  CDS  <br />  
  	<a href="user/sobrenos.php">Pop</a> <br />
    <a href="#">Rock</a><br />
    <a href="#">Punk</a><br />
    <a href="#">Metal</a><br />
...
<img src="user/images/pagamento.png" width="142" height="131"/>
